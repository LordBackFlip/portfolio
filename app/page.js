  ...
  return (
    <div className="my-8">
      ...
      <div className="flex overflow-x-auto mt-4 p-4">
        {games.map((game) => (
          <div key={game.id} className="m-2 w-36 sm:m-4 sm:w-64">
            <div className="relative">
              <Image
                className="h-36 w-36 sm:w-60 sm:h-60 transition-all duration-200 rounded-lg shadow-3xl bg-black/30 to-white/10 aspect-square"
                src={game.icon}
                alt={game.game_name}
                loading="lazy"
                width={200}
            ...
            <div className='text-center w-36 sm:w-60'>
