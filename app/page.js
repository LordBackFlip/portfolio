  ...
  return (
    <div className="my-8">
      ...
      <div className="flex overflow-x-auto mt-4 p-4">
        {games.map((game) => (
          <div key={game.id} className="m-2 w-36">
            <div className="relative">
              <Image
                className="h-36 w-36 transition-all duration-200 hover:scale-110 rounded-lg shadow-3xl bg-black/30 to-white/10 aspect-square"
                src={game.icon}
                alt={game.game_name}
                loading="lazy"
                width={200}
